The MATLAB code files in this folder implement the methods for tractable global solutions to single-input optimal control problems in the presence of plant-model mismatch that are described in the papers "Efficient and Adaptive Global Solutions to Single-Input Optimal Control Problems via Polynomial Optimization and Gaussian Processes", "Tractable Global Solutions to Chance-Constrained Bayesian Optimal Experiment Design for Arbitrary Prior and Noise Distributions", and "Optimal Control of Dose Delivery in Atmospheric Pressure Plasma Jets". Other code files are provided for further examples.
...
- The code file test_hessian_pyrrole_bc.m provides the results for the pyrrole system in Section VII.A of the paper "Efficient and Adaptive Global Solutions to Single-Input Optimal Control Problems via Polynomial Optimization and Gaussian Processes", namely Table I and Fig. 1. The code files test_hessian_time.m and test_hessian_cost.m provide similar results for two additional examples with the chlorination system in a previous paper "Dynamic Optimization of Reaction Systems via Exact Parsimonious Input Parameterization". The code file test_casadi_pyrrole_bc.m provides the results for the pyrrole system in Section VII.B of the paper "Efficient and Adaptive Global Solutions to Single-Input Optimal Control Problems via Polynomial Optimization and Gaussian Processes", namely Fig. 2, as well as the results of model predictive control by using a parsimonious parameterization approach, single shooting, and multiple shooting.
- The code file test_hessian_lv_fim.m provides the results for the Lotka-Volterra system in Section 6.1 of the paper "Tractable Global Solutions to Chance-Constrained Bayesian Optimal Experiment Design for Arbitrary Prior and Noise Distributions", namely Table 1. The code file test_hessian_lv_mc.m provides the results for the Lotka-Volterra system in Section 6.2 of the paper "Tractable Global Solutions to Chance-Constrained Bayesian Optimal Experiment Design for Arbitrary Prior and Noise Distributions", namely Table 2. The code files test_hessian_lin_fim.m and test_hessian_lin_fim.m can be used to obtain similar results for a linear system.
- The code file test_hessian_appj.m provides the results that would be obtained if the true APPJ were perfectly known in Section IV of the paper "Optimal Control of Dose Delivery in Atmospheric Pressure Plasma Jets". The code file test_appj_track.m provides the results in the presence of plant-model mismatch and disturbances for the APPJ in Section IV of the paper "Optimal Control of Dose Delivery in Atmospheric Pressure Plasma Jets".
