...
function [J_opt,T_opt,x_opt] = calc_parsimonious(tf,N,x0_opt,ts_opt,z0_opt,p0_opt,p,phi_opt,psi_opt,F_opt)
...
J_opt = 0;
for k = 1:N
    fk = F_opt{k}('x0',x_opt(:,k),'p',p,'ts',ts_opt,'z0',z0_opt,'p0',p0_opt);
